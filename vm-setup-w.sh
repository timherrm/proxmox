# SETUP & RUN
# curl -sL https://raw.githubusercontent.com/timherrm/proxmox/master/vm-setup-w.sh | sudo -E bash -
...
fi' | tee -a /home/suherrmann/.bashrc | tee -a /root/.bashrc >/dev/null

echo '"\e[A": history-search-backward
"\e[B": history-search-forward' | tee -a /home/suherrmann/.inputrc | tee -a /root/.inputrc >/dev/null
